...
> [!CAUTION]
> Некоторые функции мода могут давать неспортивное преимущество в бою. Поэтому мод будет работать только в `Реплеях`, `Тренировочных боях`, `Топографии` и `Ангаре`. В соревновательных режимах (Случайные, Клановые, Командные бои) мод не будет работать.
