...
> [!NOTE]
> Для избежания использования мода в неспортивных целях, функционал доступен только в `Реплеях`, `Тренировочных боях`, `Топографии` и `Ангаре`. В соревновательных режимах (Случайные, Клановые, Командные бои) мод не будет работать.

> [!CAUTION]
> Будьте осторожны, часть функционала мода может попадать под критерии запрещённых модификаций по мнению компании Леста. Распространение и использование таких модификаций даже в реплеях запрещено. 
...
- `Отображать BBox` – отображает ограничивающий бокс который используется для габаритных точек.
  - `Направляющие линии` – отображает направляющие линии по которым стоятся габаритные точки.

> [!NOTE]
> **Пять габаритных:**
> 1. В оси поднятия орудия при нулевом повороте башни (точка крепления не всегда в маске)
> 2. Центр передней грани BBox'а корпуса
> 3. Центр задней грани BBox'а корпуса
> 4. Центр левой грани BBox'а корпуса и поднятая по высоте до первой точки
> 5. Центр правой грани BBox'а корпуса и поднятая по высоте до первой точки
> 
> **Две обзорно габаритных:**
> 1. В PivotPoint'e танка, поднятая на высоту BBox'a вокруг башни и корпуса (без учёта пушки, даже там где башня это пушка)
> 2. Там же где и первая габаритная, но с учётом вращения башни. (**динамическая**)
